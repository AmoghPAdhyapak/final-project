...
export const InsightsAPI = {
  getRisk: async (): Promise<AcademicRisk> => {
    if (isDemoToken()) return demodelay({ risk_level: "medium" as const, core_score: 72, attendance_avg: 78.4, critical_subjects: ["Renewable Energy Sources"], warning_subjects: [], low_mark_subjects: ["Renewable Energy Sources"], recommendations: ["Increase attendance.", "Focus revision on IA sessions."] });
